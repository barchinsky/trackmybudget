...
module.exports = function(app, passport, logger, jwt) {
  require('./src/routes/budget')(app, passport, logger, jwt);
  require('./src/routes/common')(app, passport, logger, jwt);
  require('./src/routes/category')(app, passport, logger, jwt);
  require('./src/routes/transaction')(app, passport, logger, jwt);
